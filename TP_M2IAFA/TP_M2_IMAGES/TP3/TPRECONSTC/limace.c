 ...
 * Les eventuels separateurs au debut de la chaene sont ignores.
 * La lecture s'arrete au premier '\n' rencontre ou lorsque la fin du fichier
 * est atteinte. Le caractere '\n' n'est pas stocke dans la chaene.
 * Le caractere '\0' est rajoute en fin de chaene. L'allocation dynamique
 * est faite dans la fonction. La liberation de la zone memoire doit etre
 * realisee par l'appelant. La taille de la zone est ajustee au nombre de
 * caractères + 1.
 * La valeur retournee est l'adresse du premier caractere de la chaene
 * ou NULL en cas de probleme (allocation memoire).
 */
