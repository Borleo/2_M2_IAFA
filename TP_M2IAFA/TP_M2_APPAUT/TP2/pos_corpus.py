...
class PostagCorpusData():
    ...
    def __init__(self, **config):
        ...
        corpus = PostagCorpus()
        train_seq = corpus.read_sequence_list_conll(find('train-02-21.conll'), max_sent_len=15, max_nr_sent=1000)
        dev_seq = corpus.read_sequence_list_conll(find('dev-22.conll'), max_sent_len=15, max_nr_sent=1000)
        test_seq = corpus.read_sequence_list_conll(find('test-23.conll'), max_sent_len=15, max_nr_sent=1000)
